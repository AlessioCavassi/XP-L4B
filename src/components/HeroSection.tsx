  ...
  return (
    <section className="hero-section relative w-full min-h-[80vh] flex items-center justify-center overflow-hidden bg-transparent">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl">
        ...
        <motion.p 
          className="text-lg md:text-xl font-medium text-white mb-4 max-w-2xl mx-auto leading-relaxed bg-[var(--purple-deep)]/80 backdrop-blur-sm p-4 rounded-lg shadow-lg"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.3 }}
        >
          <span className="font-bold text-[var(--aqua-green)] text-xl md:text-2xl drop-shadow-md">La nostra missione:</span> Elevare il potenziale umano nelle organizzazioni attraverso l&apos;innovazione digitale e il potere del gioco.
        </motion.p>
        
        <motion.p 
          className="text-lg md:text-xl text-white font-medium mb-8 max-w-2xl mx-auto leading-relaxed border-l-4 border-[var(--aqua-green)] pl-4 backdrop-blur-sm p-4 bg-gradient-to-r from-[var(--purple-deep)]/90 to-[var(--purple-light)]/80 rounded-r-lg shadow-lg"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.5 }}
        >
          Siamo esperti nella creazione di <span className="text-[var(--aqua-green)] font-bold">esperienze coinvolgenti</span> che fondono <span className="text-[var(--aqua-green)] font-bold">gamification</span>, <span className="text-[var(--aqua-green)] font-bold">realtà virtuale</span> e <span className="text-[var(--aqua-green)] font-bold">intelligenza artificiale</span> per formare, coinvolgere e ispirare il tuo pubblico. Creiamo esperienze memorabili che generano risultati misurabili.
        </motion.p>
