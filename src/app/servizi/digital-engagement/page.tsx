        ...
        <section className="py-20 bg-black">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              >
                <h3 className="text-2xl font-heading mb-4 text-[var(--aqua-green)]">Il problema dell&apos;engagement</h3>
                ...
                <div className="space-y-6 mb-8">
                  <div className="bg-[var(--purple-deep)]/50 p-6 rounded-lg shadow-md border-l-4 border-[var(--aqua-green)]">
                    <h4 className="text-xl font-medium mb-2 text-[var(--aqua-green)]">Bassa produttività</h4>
                    <p className="text-white/80">Dipendenti disimpegnati sono in media il 18% meno produttivi, con un impatto diretto sui risultati aziendali</p>
                  </div>
                  <div className="bg-[var(--purple-deep)]/50 p-6 rounded-lg shadow-md border-l-4 border-[var(--blue)]">
                    <h4 className="text-xl font-medium mb-2 text-[var(--aqua-green)]">Alto turnover</h4>
                    <p className="text-white/80">Il 40% dei dipendenti non coinvolti considera di cambiare lavoro entro un anno</p>
                  </div>
                  <div className="bg-[var(--purple-deep)]/50 p-6 rounded-lg shadow-md border-l-4 border-[var(--purple-light)]">
                    <h4 className="text-xl font-medium mb-2 text-[var(--aqua-green)]">Welfare inefficace</h4>
                    <p className="text-white/80">Solo nel 6% delle imprese italiane il welfare aziendale produce effetti positivi concreti</p>
                  </div>
                  <div className="bg-[var(--purple-deep)]/50 p-6 rounded-lg shadow-md border-l-4 border-[var(--purple-deep)]">
                    <h4 className="text-xl font-medium mb-2 text-[var(--aqua-green)]">Gap generazionale</h4>
                    <p className="text-white/80">Le aziende faticano a comunicare efficacemente con le nuove generazioni digitali</p>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="mb-20"
            >
              <h3 className="text-2xl font-heading mb-8 text-center text-[var(--aqua-green)]">Ambiti di applicazione del Digital Engagement</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-[var(--purple-deep)]/30 p-8 rounded-xl shadow-lg border-t-4 border-[var(--blue)]">
                  ...
                  <h4 className="text-xl font-heading mb-4 text-[var(--aqua-green)]">Apprendimento continuo</h4>
                  ...
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-white/80">Micro-learning contestuale</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-[var(--blue)] mr-2">•</span>
                      <span className="text-white/80">Quiz e sfide di apprendimento</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-[var(--blue)] mr-2">•</span>
                      <span className="text-white/80">Percorsi personalizzati</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-[var(--blue)] mr-2">•</span>
                      <span className="text-white/80">Riconoscimento delle competenze</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-[var(--purple-deep)]/30 p-8 rounded-xl shadow-lg border-t-4 border-[var(--aqua-green)]">
                  ...
                  <h4 className="text-xl font-heading mb-4 text-[var(--aqua-green)]">Comunicazione interna</h4>
                  <p className="text-white/80 mb-4">
                  ...
                  <ul className="text-sm text-white/70 space-y-2">
                    <li className="flex items-start">
                      <span className="text-[var(--aqua-green)] mr-2">•</span>
                      <span className="text-white/80">Social feed gamificati</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-[var(--aqua-green)] mr-2">•</span>
                      <span className="text-white/80">Storytelling interattivo</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-[var(--aqua-green)] mr-2">•</span>
                      <span className="text-white/80">Survey e feedback coinvolgenti</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-[var(--aqua-green)] mr-2">•</span>
                      <span className="text-white/80">Condivisione di successi e risultati</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-[var(--purple-deep)]/30 p-8 rounded-xl shadow-lg border-t-4 border-[var(--purple-light)]">
                  ...
                  <h4 className="text-xl font-heading mb-4 text-[var(--aqua-green)]">Employee Experience</h4>
                  <p className="text-white/80 mb-4">
                  ...
                  <ul className="text-sm text-white/70 space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-white/80">Onboarding personalizzato</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-[var(--purple-light)] mr-2">•</span>
                      <span className="text-white/80">Riconoscimento e reward</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-[var(--purple-light)] mr-2">•</span>
                      <span className="text-white/80">Community e collaborazione</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-[var(--purple-light)] mr-2">•</span>
                      <span className="text-white/80">Welfare gamificato</span>
                    </li>
                  </ul>
                </div>
              </div>
