            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              >
                <div className="text-center mb-8">
                  <h3 className="text-2xl font-heading font-bold text-[var(--aqua-green)] mb-2">Vantaggi della Realtà Virtuale</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-[var(--purple-deep)]/50 to-black p-6 rounded-xl border border-[var(--aqua-green)]/30 hover:shadow-lg transition-all duration-300">
                    <h4 className="text-3xl font-heading font-bold text-[var(--aqua-green)] mb-3">+76%</h4>
                    <p className="text-white/80 leading-relaxed">Miglioramento della ritenzione rispetto ai metodi tradizionali</p>
                  </div>
                  
                  <div className="bg-gradient-to-br from-[var(--purple-deep)]/50 to-black p-6 rounded-xl border border-[var(--aqua-green)]/30 hover:shadow-lg transition-all duration-300">
                    <h4 className="text-3xl font-heading font-bold text-[var(--aqua-green)] mb-3">4x</h4>
                    <p className="text-white/80 leading-relaxed">Più veloce dell&apos;apprendimento in aula tradizionale</p>
                  </div>
                  
                  <div className="bg-gradient-to-br from-[var(--purple-deep)]/50 to-black p-6 rounded-xl border border-[var(--aqua-green)]/30 hover:shadow-lg transition-all duration-300">
                    <h4 className="text-3xl font-heading font-bold text-[var(--aqua-green)] mb-3">-40%</h4>
                    <p className="text-white/80 leading-relaxed">Riduzione degli errori nelle procedure operative</p>
                  </div>
                  
                  <div className="bg-gradient-to-br from-[var(--purple-deep)]/50 to-black p-6 rounded-xl border border-[var(--aqua-green)]/30 hover:shadow-lg transition-all duration-300">
                    <h4 className="text-3xl font-heading font-bold text-[var(--aqua-green)] mb-3">275%</h4>
                    <p className="text-white/80 leading-relaxed">Aumento della fiducia nell&apos;applicare nuove competenze</p>
                  </div>
                </div>
              </motion.div>
            </div>
